...
var height = this.scale (pt1.distance (pt2));
radius = this.scale (radius);
this.output (" scale='" + radius + " " + J["export"].___Exporter.round (height) + " " + radius + "'");
this.output (">");
...
this.output (" scale='" + J["export"].___Exporter.round (radius) + " " + J["export"].___Exporter.round (height) + " " + J["export"].___Exporter.round (radius) + "'");
this.output (">\n<Shape><IndexedFaceSet ");
var child = this.useTable.getDef ("c");
if (child.charAt (0) == '_') {
this.output (" DEF='" + child + "'");
...
this.output (" scale='" + this.scale (radius) + " " + J["export"].___Exporter.round (height) + " " + this.scale (radius) + "'");
} else {
...
Clazz.overrideMethod (c$, "outputSphereChildScaled", 
function (ptCenter, radius, points, colix) {
this.output ("<Transform translation='");
this.output (ptCenter);
if (points == null) this.output ("' scale='" + radius + " " + radius + " " + radius + "'");
 else this.outputQuaternionFrame (this.center, points[1], points[3], points[5], 1, 1, 1, "='", "'");
this.output (">\n<Shape><IndexedFaceSet ");
var child = this.useTable.getDef ("S");
if (child.charAt (0) == '_') {
this.output (" DEF='" + child + "'");
...
var child = this.useTable.getDef ("C" + "_" + endcaps);
this.output ("<Shape><IndexedFaceSet ");
if (child.charAt (0) == '_') {
this.output ("DEF='" + child + "'");
