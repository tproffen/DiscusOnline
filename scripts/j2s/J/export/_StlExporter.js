...
Clazz.load (["J.export._VrmlExporter", "JU.M4", "$.P3"], "J.export._StlExporter", ["java.io.ByteArrayOutputStream", "java.lang.Float", "JU.BinaryDocument", "$.Lst", "$.Measure", "$.OC", "JU.Logger", "JV.Viewer"], function () {
...
Clazz.overrideMethod (c$, "outputTranslation", 
function (pt) {
...
Clazz.overrideMethod (c$, "outputScale", 
function (x, y, z) {
this.m4a.setIdentity ();
this.m4a.m00 = x;
this.m4a.m11 = y;
