...
Clazz.load (["J.export.__CartesianExporter", "java.util.Hashtable", "JU.P3"], "J.export._VrmlExporter", ["java.lang.Boolean", "$.Float", "$.Short", "JU.A4", "$.AU", "$.Lst", "$.PT", "$.Quat", "J.export.UseTable", "JU.Geodesic", "JV.Viewer"], function () {
...
function (ptCenter, ptX, ptY, ptZ, xScale, yScale, zScale, pre, post) {
...
this.output (" scale");
this.output (pre);
this.output (J["export"].___Exporter.round (sx) + " " + J["export"].___Exporter.round (sy) + " " + J["export"].___Exporter.round (sz));
this.output (post);
}}, "JU.P3,JU.P3,JU.P3,JU.P3,~N,~N,~N,~S,~S");
...
var ndeg = 10;
var n = Clazz.doubleToInt (360 / ndeg);
var vertexCount = n * 2 + (addEndCaps ? 2 : 0);
...
this.pushMatrix ();
this.outputTranslation (ptCenter);
if (points == null) this.outputScale (radius, radius, radius);
...
Clazz.defineMethod (c$, "outputScale", 
function (x, y, z) {
this.output (" scale " + J["export"].___Exporter.round (x) + " " + J["export"].___Exporter.round (y) + " " + J["export"].___Exporter.round (z));
}, "~N,~N,~N");
Clazz.defineMethod (c$, "outputTranslation", 
function (pt) {
